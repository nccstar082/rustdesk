...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(check_ws("127.0.0.1:34675"), "ws://127.0.0.1:34678");
        assert_eq!(check_ws("127.0.0.1:34676"), "ws://127.0.0.1:34678");
        assert_eq!(check_ws("127.0.0.1:34677"), "ws://127.0.0.1:34679");
        assert_eq!(check_ws("rustdesk.com:34675"), "ws://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:34676"), "ws://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:34677"), "ws://rustdesk.com/ws/relay");
        ...
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:34675"),
            "ws://[0:0:0:0:0:0:0:1]:34678"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:34676"),
            "ws://[0:0:0:0:0:0:0:1]:34678"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:34677"),
            "ws://[0:0:0:0:0:0:0:1]:34679"
        );
        assert_eq!(check_ws("rustdesk.com:34675"), "wss://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:34676"), "wss://rustdesk.com/ws/id");
        assert_eq!(
            check_ws("rustdesk.com:34677"),
            "wss://rustdesk.com/ws/relay"
        );
        // set relay-server with default port
        Config::set_option("relay-server".to_string(), "127.0.0.1:34677".to_string());
        assert_eq!(check_ws("127.0.0.1:34675"), "ws://127.0.0.1:34678");
        assert_eq!(check_ws("127.0.0.1:34676"), "ws://127.0.0.1:34678");
        assert_eq!(check_ws("127.0.0.1:34677"), "ws://127.0.0.1:34679");
