...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "亿芯电子远程协助"),
        ("desk_tip", "扫码向我提供ID号我您提供服务"),
        ("Password", "密码"),
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "请点击下面的按钮将 RustDesk 安装到系统。"),
